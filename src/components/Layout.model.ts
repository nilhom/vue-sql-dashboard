...
import { DashItem } from "./DashItem.model.js";
    ...
    moveItemFromCollision(
        ...
        if (isUserAction) {
            const fakeItem: Item = {
                ...
                x: itemToMove.x,
                y: itemToMove.y,
                headerText: itemToMove.headerText,
                sql_query: itemToMove.sql_query,
                bar_type: itemToMove.bar_type,
                newTableSelected: itemToMove.newTableSelected,
